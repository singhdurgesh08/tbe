        ...
        <div class="modal-content">
            ...
            <form method='post' id="accept_match" name="accept_match"  class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="join_fee" class="control-label col-sm-6">registration fee per player ($)</label>
                        <div class="col-sm-6 input"> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3 input text-center">
                            <button class="btn btn-primary" type="submit" name="submit" value="Join" onclick="joinMatch();">Accept Match</button>
                        </div>
