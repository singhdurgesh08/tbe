<section class="index_membership">
    ...
    <div class="col-sm-12 home_price_seection">
        ...
        <!--<li>20% of winnings will be taken for free membership</li>-->
            ...
            <div>
    <?php  if($_SESSION['user_data']['user_name'] == ''){
    ?>
        
        <a href="<?php  echo $baseurl; ?>registration" class="col-md-8 btn btn-success member_submit" style="margin-left: 16%;"><span class="glyphicon glyphicon-user"></span>  Signup </a>
...
<!--   <li>Challenge teams</li>-->
        ...
        <form id="add_wallet" name="add_wallet" action="subscribe_dimond_membership" method="post">
